...
RUN_NAME="Complete_run_$(date +'%Y%m%d_%H%M%S')"
...
python llm_generator/test_existing_circuits.py --input_dir local_saved_circuits/$RUN_NAME/assembled --workers 4 --language guppy
